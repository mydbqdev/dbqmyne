	...
	@Valid
	  ...
	  public boolean equals(java.lang.Object o) {
	    ...
	    return Objects.equals(this.listingId, ListingBody.listingId) &&
	        ...
	        Objects.equals(this.zipCode, ListingBody.zipCode) &&
	        Objects.equals(this.title, ListingBody.title) &&
	        Objects.equals(this.description, ListingBody.description) &&
	        Objects.equals(this.isFree, ListingBody.isFree) &&
	        Objects.equals(this.price, ListingBody.price) &&
	  ...
	  @Override
	  public int hashCode() {
	    return Objects.hash(listingId, creatorId, creatorName, zipCode, title, description, isFree, price, condition, isDiscount, discountAmount, mediaPaths, createdAt, updatedAt, pickupLocation);
	  }
