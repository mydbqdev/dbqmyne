...
public class ListingController implements ListingApi {
	...
	public ResponseEntity<Object> listingsuserIdSavePost(String userId, @Valid ListingBody body) {
    	            ...
    	            ResponseEntity<Object> entity =null;
    		            ...
    		            try {
    		    	    	...
    		    	    	String message = listingService.createListing(userId,body) ;
    ...
    public ResponseEntity<Object> getlistingListingIdGet(
            @PathVariable("listing_id") String listingId) {
        try {
    ...
    public ResponseEntity<Object> updatelistingsUserIdListingIdPut( String userId ,String listingId ,@Valid ListingBody body) 
    {		  ResponseEntity<Object> entity =null;
    ...
    public ResponseEntity<Object> getlistingsGet(@NotNull @Valid String filterType,
    		@Valid String category,@Valid Boolean isFree, @Valid Boolean isDiscount, @Valid Integer pageIndex, @Valid Integer pageSize,@Valid String searchTerm) {
    	
	          	 ResponseEntity<Object> entity =null;

    		            try {
    		    	    	List<ListingResponse> posts = listingService.getListings(filterType,category,isFree,isDiscount,pageIndex,pageSize,searchTerm) ;
